...
/*
    ...
    cf) 유일성 제약: 하나의 테이블 당 하나의 기본키만!!! 지정 가능
...
# 1) '기존 테이블의' 제약 조건 삭제
# : 기본 키 제약 조건 삭제 시 not null에 대한 조건을 사라지지 않음
...
-- CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `members`
--  (`member_id`))
