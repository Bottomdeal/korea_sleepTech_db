...
-- values
-- 	('고혁재', '코리아', 23);
-- Error Code: 1366. Incorrect integer value: '코리아' for column 'age' at row 1
...
# cf) 시작 값 변경
alter table `example02` auto_increment=100;	# 테이블 생성 시 
...
# >> 엄격 모드에서는 Key(PK)값을 사용해야만 레코드 삭제 가능
